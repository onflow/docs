...
function UseFlowQueryCardMini({ darkMode }: { darkMode: boolean }) {
  const {
    data: result,
    isLoading,
    refetch,
  ...
  return (
    <EnhancedCard
      title="useFlowQuery"
      description="Execute Cadence scripts on Flow"
      darkMode={darkMode}
    >
      <div style={{ marginTop: '1rem' }}>
        <button
...
function UseFlowMutateCardMini({ darkMode }: { darkMode: boolean }) {
  ...
  return (
    <EnhancedCard
      title="useFlowMutate"
      description="Send transactions to Flow blockchain"
      darkMode={darkMode}
    >
      <div style={{ marginTop: '1rem' }}>
        <button
          ...
          style={{
            width: '100%',
            padding: '0.75rem',
            background: isPending ? '#9ca3af' : '#00ef8b',
            color: '#000',
            border: 'none',
            borderRadius: '8px',
            fontSize: '0.875rem',
        ...
        {txId && (
          <div
            style={{
              ...
              borderRadius: '8px',
              border: `1px solid ${
                darkMode ? 'rgba(0, 239, 139, 0.2)' : 'rgba(0, 239, 139, 0.15)'
              }`,
            }}
          >
            <div
