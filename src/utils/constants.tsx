...
export const DISCOURSE_BREAKING_CHANGES_URL =
  'https://forum.flow.com/c/announcements/breaking-changes/30.json';
export const DISCOURSE_MAINNET_SPORK_URL =
  'https://forum.flow.com/c/mainnet-sporks/36.json';
export const DISCOURSE_LATEST_TOPICS_URL =
  'https://forum.flow.com/latest.json';
export const DISCOURSE_API_URL = 'https://forum.flow.com';
