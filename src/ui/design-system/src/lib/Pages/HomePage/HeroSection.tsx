      ...
      <div className="flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="flex-1 max-w-2xl text-left">
          ...
          <p className="text-base md:text-lg text-gray-700 dark:text-gray-200 mb-4 max-w-xl">
            Start building with <strong>Cadence</strong>, or <strong>Solidity (EVM)</strong>, with <strong>AI-powered tools</strong>. Build the next killer app only possible on Flow.
          </p>
