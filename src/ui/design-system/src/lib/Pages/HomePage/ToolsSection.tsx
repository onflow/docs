        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {cards.map((card, idx) => (
            <a
              ...
              className="group flex flex-col p-5 rounded-xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-[#00EF8B] dark:hover:border-[#00EF8B] transition-all duration-200 no-underline hover:no-underline hover:-translate-y-1 hover:shadow-md"
              onClick={(e) => {
                event({
            ...
            >
              <span className="flex items-center justify-center w-10 h-10 rounded-lg bg-[#00EF8B]/10 mb-4">
                {card.icon && <Icon name={card.icon} className="w-5 h-5 text-[#00EF8B]" />}
              </span>
