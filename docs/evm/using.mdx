...
Composability:
- Cadence Calls: Cadence can call Flow EVM.
- Precompiles: EVM smart contracts interact with Cadence.
- Cadence-Owned-Account (COA): Allows a Cadence resource to own/control an EVM address.
