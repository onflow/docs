...
See the [staking documentation](./staking-contract-reference.mdx) for how to get info about a staked node.
...
See the [staking documentation](./staking-contract-reference.mdx) for how to get info about a staked delegator.
