...
The staking collection setup and guide is detailed in the [staking collection guide.](./staking-collection.mdx)
...
The basic staking guide is detailed [here](./unlocked-staking-guide.mdx)
