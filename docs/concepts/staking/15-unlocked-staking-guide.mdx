...
To register as a node operator with unlocked FLOW, the token holder can use the **Register Node** ([SC.11](../core-contracts/06-staking-contract-reference.md#staking))
...
To stake new tokens, the token holder can use the **Stake New Locked FLOW** ([SC.12](../core-contracts/06-staking-contract-reference.md#staking)) 
transaction with the following arguments:
