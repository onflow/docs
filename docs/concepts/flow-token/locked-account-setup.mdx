...
<Callout type="warning">
  ...
  please see our guides on staking [here](../nodes/staking/).
...
the **Set Up Creator Account** ([C.01](../core-contracts/12-locked-tokens.md#custodian)) transaction.
...
The **Deposit Account Creator** ([TA.06](../core-contracts/12-locked-tokens.md#token-admin)) transaction 
...
create both accounts using the **Create Shared Lease Accounts** ([C.04](../core-contracts/12-locked-tokens.md#custodian))
...
run the **Create Only Shared Account** ([C.03](../core-contracts/12-locked-tokens.md#custodian))
transaction with the following arguments:
