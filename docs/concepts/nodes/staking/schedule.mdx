...
See [Epoch Preparation Protocol](./epoch-preparation.mdx#epoch-length) for details. 
...
See [Epoch Setup](./epoch-preparation.mdx#phase-1-epoch-setup) for more information on this phase.
...
The first, and longest phase of an epoch is the [staking auction](./epoch-preparation.mdx#phase-0-staking-auction).
...
The [Epoch Setup](./epoch-preparation.mdx#phase-1-epoch-setup)
and [Epoch Commit](./epoch-preparation.mdx#phase-2-epoch-committed)
