...
The locked account setup is detailed in the [locked account setup page](../../../concepts/flow-token/locked-account-setup.mdx)
and the [locked account staking guide.](./locked-staking-guide.mdx)
