...
See the [Staking Collection Docs](./staking-collection.mdx#machine-account-support)
...
[the transaction to register.](./staking-collection.mdx#register-a-new-staked-node)
...
they can use the [`create_machine_account.cdc` transaction.](./staking-collection.mdx#create-a-machine-account-for-an-existing-node)

If a user is not using the staking collection, they can use the **Create QC Voter** ([QC.01](../../../cadence/core-contracts/epoch-contract-reference.mdx#quorum-certificate-transactions-and-scripts))
...
automatically using the **Submit QC Vote** ([QC.02](../../../cadence/core-contracts/epoch-contract-reference.mdx#quorum-certificate-transactions-and-scripts))
...
If a user is not using the staking collection, they can use the **Create DKG Participant** ([DKG.01](../../../cadence/core-contracts/epoch-contract-reference.mdx#dkg-transactions-and-scripts))
...
automatically using the **Post Whiteboard Message** ([DKG.02](../../../cadence/core-contracts/epoch-contract-reference.mdx#dkg-transactions-and-scripts))
transaction with the following arguments.
...
automatically using the **Send Final Submission** ([DKG.03](../../../cadence/core-contracts/epoch-contract-reference.mdx#dkg-transactions-and-scripts))
transaction with the following arguments.
