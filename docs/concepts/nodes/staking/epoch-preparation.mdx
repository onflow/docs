...
Specifically, it is allowed to emit [Service Events](./epoch-scripts-events.md#monitor-epoch-service-events),
...
See the [Epoch Setup Event Documentation](./epoch-scripts-events.md#epochsetup)
...
See the [Epoch Commit Event Documentation](./epoch-scripts-events.md#epochcommit)
...
See the [epoch scripts and events document](./epoch-scripts-events.md#introduction) for detailed documentation about
