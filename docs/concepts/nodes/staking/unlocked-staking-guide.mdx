...
Please see the [locked staking guide](./locked-staking-guide.mdx) 
...
To register as a node operator with unlocked FLOW, the token holder can use the **Register Node** ([SC.11](../../../cadence/core-contracts/staking-contract-reference.mdx#staking))
...
To stake new tokens, the token holder can use the **Stake New Locked FLOW** ([SC.12](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) 
transaction with the following arguments:
...
To staked unstaked tokens, the token holder can use the **Re-stake Unstaked FLOW** ([SC.13](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) 
transaction with the following arguments:
...
To stake rewarded tokens, the token holder can use the **Re-stake Rewarded FLOW** ([SC.14](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) 
transaction with the following arguments:
...
the **Request Unstaking** ([SC.15](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) transaction.
...
the **Unstake All FLOW** ([SC.16](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) transaction.
...
the token holder can use the **Withdraw Unstaked FLOW** ([SC.17](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) 
transaction with the following arguments:
...
the token holder can use the **Withdraw Rewarded FLOW** ([SC.18](../../../cadence/core-contracts/staking-contract-reference.mdx#staking)) 
transaction with the following arguments:
...
To register as a delegator, the token holder can use the **Register Delegator** ([SC.19](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
...
the token holder can use the **Delegate New FLOW** ([SC.20](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating)) 
transaction with the following arguments:
...
the token holder can use the **Re-delegate Unstaked FLOW** ([SC.21](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
...
the token holder can use the **Re-delegate Rewarded FLOW** ([SC.22](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
...
the token holder can use the **Unstake Delegated FOW** ([SC.23](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
...
To withdraw unstaked tokens, 
the token holder can use the **Withdraw Unstaked FLOW** ([SC.24](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
...
To withdraw rewarded tokens, 
the token holder can use the **Withdraw Rewarded FLOW** ([SC.25](../../../cadence/core-contracts/staking-contract-reference.mdx#delegating))
transaction with the following arguments:
