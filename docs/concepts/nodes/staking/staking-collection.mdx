...
using [the `FlowIDTableStaking` contract](../../../cadence/core-contracts/staking-contract-reference.mdx)
and [the `FlowStakingCollection` contract.](../../../cadence/core-contracts/staking-collection.mdx/)
...
[the unlocked staking guide](./unlocked-staking-guide.mdx)
...
The same applies to the [locked tokens staking guide](./locked-staking-guide.mdx).
...
To set up a Staking Collection, you must run the **Setup Staking Collection** ([SCO.01](../../../cadence/core-contracts/staking-collection.mdx)) transaction.
...
you must submit the **Create Machine Account** ([SCO.03](../../../cadence/core-contracts/staking-collection.mdx))
...
To register a new staked node, you must submit the **Register Node** ([SCO.03](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
To register a new delegator, you must submit the **Register Delegator** ([SCO.02](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake New Tokens** ([SCO.06](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.08](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.07](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake Tokens** ([SCO.05](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake All** ([SCO.09](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Unstaked Tokens** ([SCO.11](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Rewarded Tokens** ([SCO.10](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Close Stake** ([SCO.12](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Node** ([SCO.13](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Delegator** ([SCO.14](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Update Networking Address** ([SCO.22](../../../cadence/core-contracts/staking-collection.mdx))
transaction with the following arguments:
...
can use the **Get All Node Info** ([SCO.15](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get All Delegator Info** ([SCO.16](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get All Node Ids** ([SCO.17](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get All Delegator Ids** ([SCO.16](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get Locked Tokens Used** ([SCO.19](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get Unlocked Tokens Used** ([SCO.20](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get Does Node Exist** ([SCO.21](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
...
can use the **Get Machine Account Info** ([SCO.21](../../../cadence/core-contracts/staking-collection.mdx)) script with the following arguments:
