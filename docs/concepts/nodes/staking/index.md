...
Any wallet that uses the [Flow Client Library](../../../tooling/fcl-js/index)
...
Please see [our guides](./custody-providers) for more information about staking
...
See the [staking technical overview](./technical-overview) first,
followed by the [staking technical guide](./locked-staking-guide) 
