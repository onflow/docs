...
To deploy a contract, please follow the steps outlined in the [Dapp Deployment guide](../../../tutorials/deployment.md).
...
Please review the [Dapp Deployment guide](../../../tutorials/deployment.md) for all details.

## Is there a testnet/devnet?

There is an access node for you to develop against on the testnet/devnet. You can learn more about it [here](../../../tutorials/testnet-deployment.md#accessing-flow-testnet)
...
Yes: [testnet-deployment](../../../tutorials/testnet-deployment.md)
