...
│ ├── genesis-qc.json
│ ├── node-id
│ ├── node-info.access(all).{node id}.json
│ └── node-infos.access(all).json
├── <additional files...>
```
