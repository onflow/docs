...
You can confirm your node's successful registration and authorization by executing a Cadence script to query the [Staking Contract](../../../cadence/core-contracts/staking-contract-reference#contract).
