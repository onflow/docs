...
of the `Epoch Setup Phase` to participate in the [Epoch Preparation Protocol](../../../run-and-secure/staking/04-epoch-preparation.mdx#phase-1-epoch-setup).
...
accounts [here](../../../run-and-secure/staking/machine-account).
