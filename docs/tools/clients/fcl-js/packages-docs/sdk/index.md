...
- [authzDeepResolveMany](./authzDeepResolveMany.md) - Creates a deep test authorization resolver with nested resolution for complex...
- [authzFn](./authzFn.md) - Creates a test authorization function for testing transactions.
- [authzResolve](./authzResolve.md) - Creates a test authorization resolver that can be used for testing account...
- [authzResolveMany](./authzResolveMany.md) - Creates a test authorization resolver that handles multiple accounts with...
- [Bad](./bad.md) - Marks an interaction as failed with a specific reason and returns the...
...
- [buildPreSignable](./buildPreSignable.md) - Builds a pre-signable object containing interaction data before signing.
- [buildSignable](./buildSignable.md) - Builds a signable object that can be signed by an authorization function.
...
- [decodeResponse](./decodeResponse.md) - Decodes a response from Flow into JSON
- [decodeStream](./decodeStream.md) - Pipes a generic stream of data into a granular stream of decoded data. The data...
...
- [findInsideSigners](./findInsideSigners.md) - Identifies signers for the transaction payload (authorizers + proposer,...
- [findOutsideSigners](./findOutsideSigners.md) - Identifies signers for the transaction envelope (payer accounts only). This...
...
- [getLatestBlock](./getLatestBlock.md) - A builder function that returns the interaction to get the latest block This...
...
- [getTransport](./getTransport.md) - Get the SDK transport object, either from the provided override or from the...
- [idof](./idof.md) - Generates a unique identifier for an account based on its address and key ID.
- [initAccount](./initAccount.md) - Creates a new account object with default values.
...
- [isAccount](./isAccount.md) - Checks if an object is an account resolver.
- [isArgument](./isArgument.md) - Checks if an object is an argument resolver.
- [isArray](./isArray.md) - Checks if a value is an array.
- [isBad](./isBad.md) - Checks if an interaction has a failed status.
- [isFn](./isFn.md) - Checks if a value is a function.
- [isInteraction](./isInteraction.md) - Checks if an object is a valid interaction.
- [isNull](./isNull.md) - Checks if a value is null or undefined.
- [isNumber](./isNumber.md) - Checks if a value is a number.
- [isObj](./isObj.md) - Checks if a value is an object (but not null).
...
- [makeArgument](./makeArgument.md) - Creates an argument resolver and adds it to an interaction. This function is...
- [nodeVersionInfo](./nodeVersionInfo.md) - Retrieve version information from the connected Flow Access Node. This function...
- [Ok](./ok.md) - Marks an interaction as successful and returns the interaction object.
...
- [prepAccount](./prepAccount.md) - Prepares and configures an account for use in an interaction with a specific...
...
- [resolveCadence](./resolveCadence.md) - Resolves Cadence code by evaluating functions and replacing contract...
- [resolveComputeLimit](./resolveComputeLimit.md) - Resolves the compute limit for a transaction from configuration or applies...
...
- [run](./run.md) - Runs a set of functions on an interaction This is a utility function for testing...
...
- [sig](./sig.md) - Generates a test signature string for an account.
...
- [validateSignableTransaction](./validateSignableTransaction.md) - Validates that a signable transaction is properly formed and contains the...
