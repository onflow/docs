...
```bash
npm install @onflow/fcl-react-native
```

Or using yarn:

```bash
yarn add @onflow/fcl-react-native
```
...
```typescript
import { functionName } from "@onflow/fcl-react-native"
```
...
- [ServiceDiscovery](./serviceDiscovery.md) (namespace) - Namespace containing ServiceDiscovery utilities
- [signUp](./signUp.md)
...
- [unauthenticate](./unauthenticate.md)
- [useServiceDiscovery](./useServiceDiscovery.md) (namespace) - Namespace containing useServiceDiscovery utilities
- [useServiceDiscovery.getAsyncStorage](./useServiceDiscovery.md#getAsyncStorage)
