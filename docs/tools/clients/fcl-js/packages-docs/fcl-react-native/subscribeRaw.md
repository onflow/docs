...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-react-native/../sdk/src/transport/subscribe/subscribe-raw.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-react-native/../sdk/src/transport/subscribe/subscribe-raw.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { subscribeRaw } from "@onflow/fcl-react-native"
