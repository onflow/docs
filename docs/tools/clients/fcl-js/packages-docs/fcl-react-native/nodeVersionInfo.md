...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-react-native/../sdk/src/node-version-info/node-version-info.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-react-native/../sdk/src/node-version-info/node-version-info.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { nodeVersionInfo } from "@onflow/fcl-react-native"
