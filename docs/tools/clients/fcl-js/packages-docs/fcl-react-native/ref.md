...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-react-native/../sdk/src/build/build-ref.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-react-native/../sdk/src/build/build-ref.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { ref } from "@onflow/fcl-react-native"
