...
- [createFcl](./createFcl.md) - Creates a configured FCL (Flow Client Library) core instance. This function...
...
- [getMutate](./getMutate.md) - Legacy factory function that creates a mutate function using global FCL context....
