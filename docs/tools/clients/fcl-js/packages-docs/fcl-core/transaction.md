...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-core/../sdk/src/build/build-transaction.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-core/../sdk/src/build/build-transaction.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { transaction } from "@onflow/fcl-core"
