...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-core/../sdk/src/build/build.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-core/../sdk/src/build/build.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { build } from "@onflow/fcl-core"
