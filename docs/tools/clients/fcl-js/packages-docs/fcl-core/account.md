...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-core/../sdk/src/account/account.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-core/../sdk/src/account/account.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { account } from "@onflow/fcl-core"
