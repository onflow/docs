...
<!-- THIS DOCUMENT IS AUTO-GENERATED FROM [onflow/fcl-core/../sdk/src/transport/subscribe/subscribe.ts](https://github.com/onflow/fcl-js/tree/master/packages/fcl-core/../sdk/src/transport/subscribe/subscribe.ts). DO NOT EDIT MANUALLY -->
...
```typescript
import { subscribe } from "@onflow/fcl-core"
