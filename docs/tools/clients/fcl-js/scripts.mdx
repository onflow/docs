...
Things like [Resources](../../../building-on-flow/cadence/intro.md#resources) and [Structs](../../../building-on-flow/cadence/intro.md#structures) are fairly common place in Cadence.
