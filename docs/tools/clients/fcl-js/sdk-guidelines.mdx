...
📖 **[Proposal key](../../../build/key-concepts/transactions.md#proposal-key)** must be provided to act as a sequence number and prevent replay and other potential attacks.
