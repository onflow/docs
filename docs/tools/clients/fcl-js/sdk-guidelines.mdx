...
📖 **[Proposal key](../../../concepts/start-here/transaction-signing.md#proposal-key)** must be provided to act as a sequence number and prevent replay and other potential attacks.
