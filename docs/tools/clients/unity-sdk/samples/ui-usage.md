...
For more information about Transactions, see [cadence/language/transactions](../../../../building-on-flow/cadence/language/transactions.md).

For more information about Transaction signing, see [concepts/transaction-signing](../../../../building-on-flow/concepts/start-here/transaction-signing.md).

For more information about Cadence programming, see [cadence](../../../../building-on-flow/cadence/intro.md).
...
Only certain things in a Smart Contract can be modified. See this link about [Contract Updatability](../../../../building-on-flow/cadence/language/contract-updatability.md).
