...
We can specify aliases for each network we have defined. When deploying to testnet it is always a good idea to specify aliases for all the [common contracts](../../../../building-on-flow/concepts/core-contracts/index.md) that have already been deployed to the testnet. 
