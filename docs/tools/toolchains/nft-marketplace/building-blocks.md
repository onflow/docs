...
- [FLOW Token](../../../building-on-flow/concepts/flow-token/index.md): Native currency of the Flow blockchain used to pay for the transaction fees. NFT buyers can use FLOW tokens to buy NFTs in a marketplace.
...
| ----------------------------------- | ----------------------- | ----------------------------------------------------------------------------------------------------- |
| Smart Contract Programming Language | Solidity                | [Cadence](../../../building-on-flow/cadence/intro.md)                                                                     |
...
| Native Crypto Currency              | ETH                     | [FLOW](../../../building-on-flow/concepts/flow-token)                                                                                   |
