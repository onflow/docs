...
2. Download and install the Flow CLI, a command-line tool used to interact with the Flow blockchain. You can find the instructions for installing it [here](../../../build/getting-started/local-development/flow-cli/install.md).
