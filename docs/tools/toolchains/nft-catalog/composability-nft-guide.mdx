...
2. It is highly recommended to go through the basic NFT tutorial [here](../../../building-on-flow/cadence/tutorial/05-non-fungible-tokens-1.mdx). This is a more advanced one.
