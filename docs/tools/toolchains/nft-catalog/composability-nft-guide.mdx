...
1. To start, download and install the Flow CLI [here](../../../build/getting-started/local-development/flow-cli/install.md)
2. It is highly recommended to go through the basic NFT tutorial [here](../../../build/getting-started/hello-world/tutorial/05-non-fungible-tokens-1.md). This is a more advanced one.
