...
A transaction that declares same payer and proposer but multiple authorizers each required to sign the transaction. Please note that the order of signing is important, and [the payer must sign last](../../../build/key-concepts/transactions.md#payer-signs-last).
...
Please note that the order of signing is important, and [the payer must sign last](../../../build/key-concepts/transactions.md#payer-signs-last).  
