...
of the `Epoch Setup Phase` to participate in the [Epoch Preparation Protocol](../../references/run-and-secure/staking/04-epoch-preparation.mdx#phase-1-epoch-setup).
...
accounts [here](../../references/run-and-secure/staking/machine-account).
