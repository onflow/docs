...
#### Mainnet
##### We are still in the process of aggregating the past chain data but mainnet 5 to mainnet 1 spork data can be retrieved from the Access nodes mentioned [here](../../../references/node-operation/spork.mdx#mainnet)
...
The detailed semantics of block formation are covered in the [block formation guide](../../../build/key-concepts/blocks.md).
...
The detailed semantics of transaction creation, signing and submission are covered in the [transaction submission guide](../../../build/key-concepts/transactions.md#signing-a-transaction).

### Proposal Key

The proposal key is used to specify a sequence number for the transaction. Sequence numbers are covered in more detail [here](../../../build/key-concepts/transactions.md#sequence-numbers).

| Field           | Description                                                                          |
| --------------- | ------------------------------------------------------------------------------------ |
| address         | Address of proposer account                                                          |
| key_id          | ID of proposal key on the proposal account                                           |
| sequence_number | [Sequence number](../../../build/key-concepts/transactions.md#sequence-numbers) for the proposal key |
...
More information on accounts can be found [here](../../../build/key-concepts/accounts.md).
...
| sign_algo       | [Signature algorithm](../../../build/key-concepts/accounts.md#signature-and-hash-algorithms) |
| hash_algo       | [Hash algorithm](../../../build/key-concepts/accounts.md#signature-and-hash-algorithms)      |
| weight          | [Weight assigned to the key](../../../build/key-concepts/accounts.md#account-keys)                 |
| sequence_number | [Sequence number for the key](../../../build/key-concepts/transactions.md#sequence-numbers)             |
| revoked         | Flag indicating whether or not the key has been revoked                                 |

More information on account keys, key weights and sequence numbers can be found [here](../../../build/key-concepts/accounts.md).
