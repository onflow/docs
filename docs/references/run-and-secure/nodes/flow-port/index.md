...
### Starting a Manual Staking Transaction
 1. You need to have FLOW in order to stake. Please see the [FLOW Token](../../../../reference/core-contracts/03-flow-token.md) reference for information on how to become a FLOW holder.
