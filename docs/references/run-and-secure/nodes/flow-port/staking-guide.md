...
If you don't have this information, go [here](../../../../references/node-operation/node-bootstrap.mdx#step-1---run-genesis-bootstrap) for instructions on how to acquire it.
...
Once this is done, you can now create a [Machine Account](../../../../references/node-operation/machine-existing-operator.mdx) by clicking the "Upgrade Node" button on the Stake & Delegate page.

![Flow Port Staking](machine-account.png)

You can follow the guide [here](../../../../references/node-operation/machine-existing-operator.mdx) to create your Machine Account.
