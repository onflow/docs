...
If you don't have this information, go [here](../../../../references/run-and-secure/node-operation/node-bootstrap.md#step-1---run-genesis-bootstrap) for instructions on how to acquire it.
...
Once this is done, you can now create a [Machine Account](../../../../references/run-and-secure/node-operation/machine-existing-operator.md) by clicking the "Upgrade Node" button on the Stake & Delegate page.

![Flow Port Staking](machine-account.png)

You can follow the guide [here](../../../../references/run-and-secure/node-operation/machine-existing-operator.md) to create your Machine Account.
