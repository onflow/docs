...
There are a number of ways we could interact with this contract - Remix IDE, Foundry's CLI, Hardhat, and so on. - but for the purposes of this guide, we'll use the [Flowscan EVM block explorer].
