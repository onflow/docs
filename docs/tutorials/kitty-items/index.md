...
The following chapters use the project to explain the components and concepts of the Flow blockchain and its programming language [Cadence](../../building-on-flow/cadence/intro.md). At the end, you will be able to:
...
This is a complete web application built with NextJS and React that demonstrates how to build a website that connects directly to the Flow blockchain using [FCL](../../tools/clients/fcl-js/index.md). FCL handles authentication and authorization of [Flow accounts](../../building-on-flow/concepts/start-here/accounts-and-keys.md), [signing transactions](../../building-on-flow/concepts/start-here/transaction-signing.md), and querying data using using Cadence scripts.
