...
All NFTs on the Flow blockchain implement the [NonFungibleToken](../building-on-flow/concepts/core-contracts/08-non-fungible-token.md) interface, allowing them to be compatible with wallets, marketplaces and other cross-app experiences.

- [Non-Fungible Token (NFT) contract interface](../building-on-flow/concepts/core-contracts/08-non-fungible-token.md)
...
Fungible tokens (i.e. coins, currencies) on the Flow blockchain, including the default cryptocurrency token FLOW, implement the [FungibleToken](../building-on-flow/concepts/core-contracts/02-fungible-token.md) interface.

- [Fungible Token contract interface](../building-on-flow/concepts/core-contracts/02-fungible-token.md)
