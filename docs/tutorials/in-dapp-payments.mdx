...
FLOW is the default cryptocurrency that powers the Flow blockchain network, and is primarily used for staking and for paying [network fees](../building-on-flow/concepts/flow-token/concepts.md#fees).
