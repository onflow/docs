...
On Flow, implementing a vesting or unlock schedule in a smart contract is easy as cake. You can use [this link](../concepts/flow-token//locked-account-setup.mdx#introduction) for more information on how to do this.
