...
These third-party services can insulate your application from the requirement of being aware of [sporks](../references/node-operation/spork.mdx#past-and-upcoming-sporks).
Otherwise, you will have to add logic in your application to navigate across [past sporks](../references/node-operation/spork.mdx#past-and-upcoming-sporks) when looking up past blockchain data.
