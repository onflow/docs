...
> **Note**: This page will walk you through a very bare bones project to get started building a web3 dapp using the Flow Client Library (FCL). If you are looking for a clonable repo, check out the [scaffolds availabe in the Flow CLI](../tooling/flow-cli/super-commands/super-commands.md#using-scaffolds).
