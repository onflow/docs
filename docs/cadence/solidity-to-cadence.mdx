...
Detailed information about deploying, updating, removing or borrowing contracts can be found in [Contracts](language#contracts)
...
[Optional bindings](language#control-flow) provide in-built conditional handling of nil values. Regular data types in
