...
Possessing an entitlement allows a reference to have access to any functions on its referenced type
...
An reference will never have any more entitlements than the set with which it was created, 
