...
- Functions
- [Accounts (`Account`)](./accounts/index.mdx)
- [Transactions](./transactions.md)
- [References](./references.mdx): References are ephemeral.
  Consider [storing a capability and borrowing it](./capabilities.mdx) when needed instead.
