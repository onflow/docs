...
All state that persists permanently is stored in [accounts](../language/accounts/index.mdx)
...
1. The first area is the [contract area](../language/accounts/index.mdx).
