...
You'll learn how to interact with resources using [capabilities](../language/capabilities.mdx)
...
This is because we created a [**capability**](../language/capabilities.mdx) for the `HelloAsset` object.
Capabilities are kind of like pointers in other languages, but which much more fine-grained control.

### Capability Based Access Control

[Capabilities](../language/capabilities.mdx) allow the owners of objects
...
You can find more [detailed documentation about capabilities in the language reference.](../language/capabilities.mdx)
...
See the [language reference](../language/accounts/index.mdx) for more information about accounts.
...
Have a look at the [capability-based access control page](../language/capabilities.mdx)
