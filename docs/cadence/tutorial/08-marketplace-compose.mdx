...
- [Capabilities](../language/capabilities.mdx) allow exposing user-defined sets of functionality through special objects that enforce strict security with Cadence's type system.
...
As you hopefully understand, [capabilites](../language/capabilities.mdx)
...
To create a capability, a user typically uses [the `AuthAccount.link`](../language/accounts/index.mdx)
