...
See the [account](../language/accounts/index.mdx) documentation for a list of all the methods it can call.
...
Another important feature in Cadence is its utilization of [**Capability-Based Security.**](../language/capabilities.mdx)
