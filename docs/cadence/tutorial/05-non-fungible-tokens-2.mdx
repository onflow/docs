...
In cadence, since resources can own other resources, does it always make sense to say
that the account that owns the resource that owns other resources also owns the
sub-resources? Or are they simply the property of the resource? Its hard to say,
and you'll encounter more fascinating implications of ownership and interoperability
as you get deeper into Cadence. 
...
Normally, most would implement restricte minting by having an NFT Minter resource.
