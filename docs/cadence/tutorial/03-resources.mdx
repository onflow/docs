...
This is an [`AuthAccount` object](../language/accounts/index.mdx)
...
[private `AuthAccount` object](../language/accounts/index.mdx).
...
called [capabilities](../language//capabilities.mdx) (more on these later).
...
has access to the signing accounts' [private `AuthAccount` object](../language/accounts/index.mdx).
