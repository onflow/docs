...
corresponding to each network in the [Flow CLI configuration file](../tooling/flow-cli/configuration#contracts).
...
[statically defining contract addresses in the flow.json config file](../tooling/flow-cli/configuration#advanced-format).
</Callout>
