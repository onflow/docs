...
<Callout type="info">
The testing framework can only be used off-chain, e.g. by using the [Flow CLI](../build/getting-started/local-development/flow-cli).
</Callout>
...
corresponding to each network in the [Flow CLI configuration file](../build/getting-started/local-development/flow-cli/flow.json/configuration.md#contracts).
...
[statically defining contract addresses in the flow.json config file](../build/getting-started/local-development/flow-cli/flow.json/configuration.md#advanced-format).
</Callout>
