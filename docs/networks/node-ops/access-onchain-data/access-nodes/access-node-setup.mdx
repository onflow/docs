...
```shell
$PWD/flow-go/make docker-native-build-access-binary \
...
Once compiled the binary will be `$PWD/flow-go/flow_access_node` for an Access Node. Use the respective Makefile target to build your choice of node
