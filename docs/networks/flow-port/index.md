...
### Staking your own Node
  ...
  4. Run the [bootstrapping instructions](../../networks/node-ops/nodes/node-operation/node-bootstrap.md) and provide the remaining technical details needed to stake a node.
