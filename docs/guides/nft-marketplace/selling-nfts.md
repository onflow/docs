...
An NFT marketplace should enable users to set up their accounts to receive an NFT before purchasing that NFT. [Flow NFT Catalog](../../../tooling/nft-catalog/overview) can provide the storage path information to let platforms craft such account set up transactions.
