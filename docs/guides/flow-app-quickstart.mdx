...
<Callout type="info">
FCL (aka Flow Client Library) wraps the logic needed to communicate with the flow blockchain. It's a npm package, [More Information](../tools/toolchains/fcl-js)
</Callout>
...
<Callout type="info">
The flow.json file is used to keep track of deployed contracts and accounts. [More Information](../tools/toolchains/fcl-js/api#using-flowjson)
</Callout>
