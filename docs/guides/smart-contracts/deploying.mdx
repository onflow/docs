...
Make sure to install the Flow CLI. [Flow CLI](../../tools/flow-cli//flow-cli/accounts/create-accounts) has a interactive mode for generating keys.
...
- Follow the Flow CLI instructions to [Create a Project](../../tools/flow-cli//flow-cli). You have the Flow CLI installed and ran `flow init` or `flow setup` in your project folder and generating a `flow.json` file
...
Contracts can be updated and retain the contract address. You can use the [Flow CLI contract update command](../../tools/flow-cli/flow-cli/accounts/account-update-contract.md) to re-deploy an updated version of your contract:
...
Once all your contracts are deployed, you can visit [flow-view-source](https://flow-view-source.com/) or run the [Flow CLI get account command](../../tools/flow-cli//flow-cli/accounts/get-accounts.md) to confirm the deployment.
...
<Callout type="info">
To create accounts and generate keys, make sure to install [Flow CLI](../../tools/flow-cli//flow-cli/install). Flow CLI provides convenient functions to simplifies interacting with the blockchain.
</Callout>
...
Make sure to install the Flow CLI. [Flow CLI](../../tools/flow-cli//flow-cli/accounts/create-accounts) has a interactive mode for generating keys, using the testnet faucet to create and fund the new account.

### Creating and deploying a Project

Flow CLI can be used to create a Cadence project and stay organized, [Flow CLI: Create a project](../../tools/flow-cli//flow-cli). This will make deployment much easiler and help with the iterative development process.

After you have a project created and want to deploy your Cadence; contracts, transactions and scripts.[Flow CLI: deploy](../../tools/flow-cli//flow-cli/deployment/deploy-project-contracts.md).
