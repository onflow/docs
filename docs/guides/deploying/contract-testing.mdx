...
Leverage [Flow emulator](../../tools/toolchains/emulator/index.md) to automate test runs. Test on Flow testnet. Include unit tests; to exercise each feature, and integration tests; to exercise the behavior of different parts of the project as a whole.
</Callout>
...
<Callout type="success">
Get familiar with the [Cadence anti-patterns](../../build/best-practices/anti-patterns.md) to avoid avoid problematic or unintended behavior.
</Callout>