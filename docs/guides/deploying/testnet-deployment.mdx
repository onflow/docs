...
<Callout type="info">
To create accounts and generate keys, make sure to install [Flow CLI](../../tools/toolchains//flow-cli/install). There are a lot of convenient functions the flow CLI provides
</Callout>
