...
sidebar_label: Building a Platform
description: Buiding a Platform Application
sidebar_position: 2
---

# Platform Architecture

A platform allows users to buy and sell digital assets, such as NFTs. Platforms are typically built on top of a blockchain network, and provide a user interface for users to interact with the platform.
