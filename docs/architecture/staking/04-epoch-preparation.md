...
For each Epoch, there is a [Staking Auction](../../architecture/staking/06-technical-overview.md) in which new potential node operators may submit Staking Commitments.
...
Specifically, it is allowed to emit [Service Events](../../architecture/staking/05-epoch-scripts-events.md#monitor-epoch-service-events),
...
See the [Epoch Setup Event Documentation](../../architecture/staking/05-epoch-scripts-events.md#epochsetup)
...
See the [Epoch Commit Event Documentation](../../architecture/staking/05-epoch-scripts-events.md#epochcommit)
...
See the [epoch scripts and events document](../../architecture/staking/05-epoch-scripts-events.md#introduction) for detailed documentation about
