...
To register as a node operator with FLOW, the token holder can use the **Register Node** ([SC.11](../../references/core-contracts/06-staking-contract-reference.md#staking))
...
To stake tokens, the token holder can use the **Stake FLOW** ([SC.12](../../references/core-contracts/06-staking-contract-reference.md#staking))
transaction with the following arguments:
...
To staked unstaked tokens, the token holder can use the **Re-stake Unstaked FLOW** ([SC.13](../../references/core-contracts/06-staking-contract-reference.md#staking)) 
transaction with the following arguments:
...
To stake rewarded tokens, the token holder can use the **Re-stake Rewarded FLOW** ([SC.14](../../references/core-contracts/06-staking-contract-reference.md#staking)) 
transaction with the following arguments:
...
the **Request Unstaking** ([SC.15](../../references/core-contracts/06-staking-contract-reference.md#staking)) transaction.
...
the **Unstake All FLOW** ([SC.16](../../references/core-contracts/06-staking-contract-reference.md#staking)) transaction.
...
the token holder can use the **Withdraw Unstaked FLOW** ([SC.17](../../references/core-contracts/06-staking-contract-reference.md#staking)) 
transaction with the following arguments:
...
the token holder can use the **Withdraw Rewarded FLOW** ([SC.18](../../references/core-contracts/06-staking-contract-reference.md#staking)) 
transaction with the following arguments:
...
the token holder can use the **Unstake Delegated FOW** ([SC.23](../../references/core-contracts/06-staking-contract-reference.md#delegating))
transaction with the following arguments:
...
To withdraw rewarded tokens, 
the token holder can use the **Withdraw Rewarded FLOW** ([SC.25](../../references/core-contracts/06-staking-contract-reference.md#delegating))
transaction with the following arguments:
