...
<Callout type="warning">
Unstaking a node will result in the node [not earning rewards](../../../building-on-flow/run-and-secure/staking/06-technical-overview.mdx#staking-operations-available-to-all-stakers) for the next epoch.
