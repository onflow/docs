...
The proposal key is used to specify a sequence number for the transaction. Sequence numbers are covered in more detail [here](../../concepts/accounts.md).

| Field           | Description                                                                          |
| --------------- | ------------------------------------------------------------------------------------ |
| address         | Address of proposer account                                                          |
| key_id          | ID of proposal key on the proposal account                                           |
| sequence_number | [Sequence number](../../concepts/accounts.md) for the proposal key |
...
| sign_algo       | [Signature algorithm](../../concepts/accounts.md#supported-signature--hash-algorithms) |
| hash_algo       | [Hash algorithm](../../concepts/accounts.md#supported-signature--hash-algorithms)      |
| weight          | [Weight assigned to the key](../../concepts/accounts.md#weighted-keys)                 |
| sequence_number | [Sequence number for the key](../../concepts/accounts.md#sequence-numbers)             |
