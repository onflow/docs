...
using [the `FlowIDTableStaking` contract](../../../concepts/core-contracts/06-staking-contract-reference.md)
and [the `FlowStakingCollection` contract.](../../../concepts/core-contracts/11-staking-collection.md/)
...
To set up a Staking Collection, you must run the **Setup Staking Collection** ([SCO.01](../../../concepts/core-contracts/11-staking-collection.md)) transaction.
...
you must submit the **Create Machine Account** ([SCO.03](../../../concepts/core-contracts/11-staking-collection.md))
...
To register a new staked node, you must submit the **Register Node** ([SCO.03](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
To register a new delegator, you must submit the **Register Delegator** ([SCO.02](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake New Tokens** ([SCO.06](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.08](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.07](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake Tokens** ([SCO.05](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake All** ([SCO.09](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Unstaked Tokens** ([SCO.11](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Rewarded Tokens** ([SCO.10](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Close Stake** ([SCO.12](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Node** ([SCO.13](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Delegator** ([SCO.14](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Update Networking Address** ([SCO.22](../../../concepts/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
can use the **Get All Node Info** ([SCO.15](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Delegator Info** ([SCO.16](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Node Ids** ([SCO.17](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Delegator Ids** ([SCO.16](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Locked Tokens Used** ([SCO.19](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Unlocked Tokens Used** ([SCO.20](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Does Node Exist** ([SCO.21](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Machine Account Info** ([SCO.21](../../../concepts/core-contracts/11-staking-collection.md)) script with the following arguments:
