...
of the `Epoch Setup Phase` to participate in the [Epoch Preparation Protocol](../../../../architecture/staking/04-epoch-preparation.mdx#phase-1-epoch-setup).
...
accounts [here](../../../../architecture/staking/machine-account).
...
A snapshot can be obtained from any Access Node using [Flow CLI](../../../../build/getting-started/local-development/flow-cli/index.md).
