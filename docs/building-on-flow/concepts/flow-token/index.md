...
1. [Earn FLOW as a Validator or Delegator](../../run-and-secure/staking/06-technical-overview.mdx): Receive newly-minted FLOW as a reward for running a node.
...
[You can use FLOW to operate a staked node.](../../run-and-secure/staking/06-technical-overview.mdx) Node operators receive newly-minted FLOW
as a reward for helping to secure the network.

### Delegating FLOW

[You can use FLOW for stake delegation.](../../run-and-secure/staking/06-technical-overview.mdx) Delegators receive newly-minted FLOW
as a reward for helping to secure the network.
