...
You can use the **Get Epoch Metadata**([EP.01](../../concepts/core-contracts/07-epoch-contract-reference.md#getting-epoch-info)) script
...
You can use the **Get Configurable Metadata**([EP.02](../../concepts/core-contracts/07-epoch-contract-reference.md#getting-epoch-info)) script
...
You can use the **Get Epoch Counter**([EP.03](../../concepts/core-contracts/07-epoch-contract-reference.md#getting-epoch-info)) script
...
You can use the **Get Epoch Phase**([EP.04](../../concepts/core-contracts/07-epoch-contract-reference.md#getting-epoch-info)) script
