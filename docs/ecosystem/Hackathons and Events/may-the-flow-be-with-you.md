...
<div className="space-y-6 my-6">
  ...
  <div className="border-l-4 border-gray-300 dark:border-gray-700 pl-4 py-2">
    <h3 className="text-lg font-bold text-gray-500 dark:text-gray-400">Week 4: AI and LLMs (May 25-31)</h3>
    ...
    <ul className="mt-2 space-y-1 text-gray-500 dark:text-gray-400">
      ...
      <li>May 25-31: Build AI integrated apps (either completely new or continue building on your week 1, 2 or 3 projects)</li>
      <li>May 31: Final submission deadline</li>
      <li>June 2: Week 4 winners and jackpot announced! Note, the jackpot will consist of shortlisted projects that are the most working end-to-end and complex, check the repo for the new leaderboard to see how your project ranks relative to others!</li>
    </ul>
  </div>
</div>
