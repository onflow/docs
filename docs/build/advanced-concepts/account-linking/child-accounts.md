...
[AuthAccount](../../../cadence/language/accounts/index.mdx#authaccount) create a
[Capability](https://developers.flow.com/cadence/language/capability-based-access-control.md) on itself. You can do so in the following
transaction:
...
1. We can leverage [Cadence’s `AuthAccount.Inbox`](../../../cadence/language/accounts/index.mdx#account-inbox) to publish the
