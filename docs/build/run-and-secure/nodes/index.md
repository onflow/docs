...
The different types of nodes are described [here](../../../references/node-operation/node-roles.mdx). As node operator, you can choose to run any of the different types of node that best fits your needs.

The nodes are classified as follows,

![Flownodesdiagram.png](../../../references/node-operation/Flownodesdiagram.png)
...
<Callout type="info">
<br />
To run a light node, follow this [guide](../../../references/node-operation/observer-node.mdx)
<br />
</Callout>
...
<Callout type="info">
  <br />
  To run a self-hosted access node, follow this [guide](../../../references/node-operation/access-node-setup.md)
  <br />
</Callout>
...
1. [Provision](../../../references/node-operation/node-setup.mdx) the machine on which your node will run.

2. [Generate and register](../../../references/node-operation/node-bootstrap.mdx) your node identity.

3. [Start](../../../references/node-operation/node-bootstrap.mdx#step-3---start-your-flow-node) your node!
