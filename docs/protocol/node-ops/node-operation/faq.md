...
Network upgrade (spork) occur once every year.
Apart from the network upgrade, there are also Height Coordinated Upgrade (HCU) which occur approximately once every one or two months.
