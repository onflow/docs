...
Make sure to install the Flow CLI. [Flow CLI](../../tooling/flow-cli/accounts/create-accounts) has a interactive mode for generating keys.
...
- Follow the Flow CLI instructions to [Create a Project](../../tooling/flow-cli). You have the Flow CLI installed and ran `flow init` or `flow setup` in your project folder and generating a `flow.json` file
- Mainnet account: You completed the mainnet account setup, (see above) and have your key pair and mainnet address ready.
- [Deploy your project](../../tooling/flow-cli/deployment/deploy-project-contracts.md) now you have contracts on mainnet.
...
Contracts can be updated and retain the contract address. You can use the [Flow CLI contract update command](../../tooling/flow-cli/accounts/account-update-contract.md) to re-deploy an updated version of your contract:
