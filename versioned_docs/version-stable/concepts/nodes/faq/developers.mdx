...
To deploy a contract, please follow the steps outlined in the [Dapp Deployment guide](../../../guides/deploying/deployment.md).
...
Please review the [Dapp Deployment guide](../../../guides/deploying/deployment.md) for all details.
