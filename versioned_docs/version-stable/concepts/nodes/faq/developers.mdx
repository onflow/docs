...
To deploy a contract, please follow the steps outlined in the [Dapp Deployment guide](../../../guides/deploying/deployment).
...
Please review the [Dapp Deployment guide](../../../guides/deploying/deployment) for all details.

## Is there a testnet/devnet?

There is an access node for you to develop against on the testnet/devnet. You can learn more about it [here](../../../guides/deploying/testnet-deployment.md#accessing-flow-testnet)
...
Yes: [testnet-deployment](../../../guides/deploying/testnet-deployment.md)
