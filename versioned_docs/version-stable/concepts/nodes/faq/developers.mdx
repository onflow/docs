...
There is an access node for you to develop against on the testnet/devnet. You can learn more about it [here](../../../guide/deploying/testnet-deployment.md#accessing-flow-testnet)
...
Yes: [testnet-deployment](../../../guide/deploying/testnet-deployment.md)
