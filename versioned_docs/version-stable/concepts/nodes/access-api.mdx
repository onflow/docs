...
The proposal key is used to specify a sequence number for the transaction. Sequence numbers are covered in more detail [here](../transactions.md#sequence-numbers).

| Field           | Description                                                                          |
| --------------- | ------------------------------------------------------------------------------------ |
| address         | Address of proposer account                                                          |
| key_id          | ID of proposal key on the proposal account                                           |
| sequence_number | [Sequence number](../transactions.md#sequence-numbers) for the proposal key |
...
More information on accounts can be found [here](../accounts.md).
...
| sign_algo       | [Signature algorithm](../accounts.md#signature-and-hash-algorithms) |
| hash_algo       | [Hash algorithm](../accounts.md#signature-and-hash-algorithms)      |
| weight          | [Weight assigned to the key](../accounts.md#account-keys)                 |
| sequence_number | [Sequence number for the key](../transactions.md#sequence-numbers)             |
| revoked         | Flag indicating whether or not the key has been revoked                                 |

More information on account keys, key weights and sequence numbers can be found [here](../accounts.md).
