...
| sign_algo       | [Signature algorithm](../start-here/accounts-and-keys.md#signature-and-hash-algorithms) |
| hash_algo       | [Hash algorithm](../start-here/accounts-and-keys.md#signature-and-hash-algorithms)      |
| weight          | [Weight assigned to the key](../start-here/accounts-and-keys.md#account-keys)                 |
