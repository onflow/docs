...
If a user is not using the staking collection, they can use the **Create QC Voter** ([QC.01](../../../building-on-flow/core-contracts/07-epoch-contract-reference.md#quorum-certificate-transactions-and-scripts))
...
automatically using the **Submit QC Vote** ([QC.02](../../../building-on-flow/core-contracts/07-epoch-contract-reference.md#quorum-certificate-transactions-and-scripts))
...
If a user is not using the staking collection, they can use the **Create DKG Participant** ([DKG.01](../../../building-on-flow/core-contracts/07-epoch-contract-reference.md#dkg-transactions-and-scripts))
...
automatically using the **Post Whiteboard Message** ([DKG.02](../../../building-on-flow/core-contracts/07-epoch-contract-reference.md#dkg-transactions-and-scripts))
transaction with the following arguments.
...
automatically using the **Send Final Submission** ([DKG.03](../../../building-on-flow/core-contracts/07-epoch-contract-reference.md#dkg-transactions-and-scripts))
transaction with the following arguments.
