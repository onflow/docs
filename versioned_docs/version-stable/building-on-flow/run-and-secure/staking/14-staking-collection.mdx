...
using [the `FlowIDTableStaking` contract](../../../building-on-flow/core-contracts/06-staking-contract-reference.md)
and [the `FlowStakingCollection` contract.](../../../building-on-flow/core-contracts/11-staking-collection.md/)
...
To set up a Staking Collection, you must run the **Setup Staking Collection** ([SCO.01](../../../building-on-flow/core-contracts/11-staking-collection.md)) transaction.
...
you must submit the **Create Machine Account** ([SCO.03](../../../building-on-flow/core-contracts/11-staking-collection.md))
...
To register a new staked node, you must submit the **Register Node** ([SCO.03](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
To register a new delegator, you must submit the **Register Delegator** ([SCO.02](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake New Tokens** ([SCO.06](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.08](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Stake Unstaked Tokens** ([SCO.07](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake Tokens** ([SCO.05](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Unstake All** ([SCO.09](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Unstaked Tokens** ([SCO.11](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Withdraw Rewarded Tokens** ([SCO.10](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Close Stake** ([SCO.12](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Node** ([SCO.13](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Transfer Delegator** ([SCO.14](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
The owner of a Staking Collection can use the **Update Networking Address** ([SCO.22](../../../building-on-flow/core-contracts/11-staking-collection.md))
transaction with the following arguments:
...
can use the **Get All Node Info** ([SCO.15](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Delegator Info** ([SCO.16](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Node Ids** ([SCO.17](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get All Delegator Ids** ([SCO.16](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Locked Tokens Used** ([SCO.19](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Unlocked Tokens Used** ([SCO.20](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Does Node Exist** ([SCO.21](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
...
can use the **Get Machine Account Info** ([SCO.21](../../../building-on-flow/core-contracts/11-staking-collection.md)) script with the following arguments:
