...
Additionally, it can have below special functions:
...
- An `afterEach` function that runs after each test case.
...
// Invalid: Test functions cannot have any arguments or return values.
