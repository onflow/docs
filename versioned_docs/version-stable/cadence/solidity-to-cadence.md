...
Capabilities can be `unpublished` and can also be [revoked](../cadence/design-patterns.md#capability-revocation) by the creating
account.
...
accessible via a Capability it's easy to manage with [Capability Revocation](../cadence/design-patterns.md#capability-revocation).

The admin role originates from the [init singleton pattern](../cadence/design-patterns.md#init-singleton) and uses the
[Capability Bootstrapping](../cadence/design-patterns.md#capability-bootstrapping) pattern for making the Capability available to
other accounts.
